    ...
    public Record evaluate(Record record, Object... paras) {
        ...
        if (groovyTransformer == null) {
            ...
            if (paras.length < 1 || paras.length > 2) {
                throw DataXException.asDataXException(TransformerErrorCode.TRANSFORMER_ILLEGAL_PARAMETER, "dx_groovy paras must be 1 or 2 . now paras is: " + Arrays.asList(paras));
            }
            synchronized (this) {
