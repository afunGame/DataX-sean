...
public class CommonRdbmsWriter {
    ...
    public static class Task {
        ...
        private final int dumpRecordLimit = Constant.DEFAULT_DUMP_RECORD_LIMIT;
        private final AtomicLong dumpRecordCount = new AtomicLong(0);
        ...
        public void doOneInsert(Connection connection, List<Record> buffer) {
            ...
            try {
                ...
                System.out.println("***********************************");
                System.out.println(this.writeRecordSql);
        ...
        private void calcWriteRecordSql() {
            if (!VALUE_HOLDER.equals(calcValueHolder(""))) {
                ...
                boolean forceUseUpdate = dataBaseType != null && dataBaseType == DataBaseType.MySql && OriginalConfPretreatmentUtil.isOB10(jdbcUrl);
                //ob10的处理
